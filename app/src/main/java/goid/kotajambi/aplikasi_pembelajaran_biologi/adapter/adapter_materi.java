...
import goid.kotajambi.aplikasi_pembelajaran_biologi.menu.detail_materi;
...
public class adapter_materi extends RecyclerView.Adapter<adapter_materi.MyViewHolder> {

    private ArrayList<model_materi> dataSet;
    ...
    public adapter_materi(Context context, ArrayList<model_materi> data) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.model_materi, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, detail_materi.class);
                Bundle b = new Bundle();
                b.putString("file", String.valueOf(dataSet.get(listPosition).getFile()));
                b.putString("judul", String.valueOf(dataSet.get(listPosition).getNama_materi()));
                intent.putExtras(b);
